...
def main():
  ...
  base = {'images': [], 
         'annotations': [], 
         'categories': format_classes(annotations['all_agent_labels']),
         'loc_categories': format_classes(annotations['all_loc_labels']),
         'action_categories': format_classes(annotations['all_action_labels']),
         'duplex_categories': format_classes(annotations['all_duplex_labels']),
         'triplex_categories': format_classes(annotations['all_triplet_labels']),
